...
func (in *TokenReview) APILifecycleReplacement() pkgruntimeschema.GroupVersionKind {
	return pkgruntimeschema.GroupVersionKind{Group: "authentication.k8s.io", Version: "v1", Kind: "TokenReview"}
}
