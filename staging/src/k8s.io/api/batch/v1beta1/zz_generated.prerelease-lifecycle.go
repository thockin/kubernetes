...
func (in *CronJob) APILifecycleReplacement() pkgruntimeschema.GroupVersionKind {
	return pkgruntimeschema.GroupVersionKind{Group: "batch", Version: "v1", Kind: "CronJob"}
}
...
// APILifecycleReplacement is an autogenerated function, returning the group, version, and kind that should be used instead of this deprecated type.
// It is controlled by "k8s:prerelease-lifecycle-gen:replacement=<group>,<version>,<kind>" tags in types.go.
func (in *CronJobList) APILifecycleReplacement() pkgruntimeschema.GroupVersionKind {
	return pkgruntimeschema.GroupVersionKind{Group: "batch", Version: "v1", Kind: "CronJobList"}
}
