...
func (in *CSIStorageCapacity) APILifecycleReplacement() pkgruntimeschema.GroupVersionKind {
	return pkgruntimeschema.GroupVersionKind{Group: "storage.k8s.io", Version: "v1beta1", Kind: "CSIStorageCapacity"}
}
...
func (in *CSIStorageCapacityList) APILifecycleReplacement() pkgruntimeschema.GroupVersionKind {
	return pkgruntimeschema.GroupVersionKind{Group: "storage.k8s.io", Version: "v1beta1", Kind: "CSIStorageCapacityList"}
}
