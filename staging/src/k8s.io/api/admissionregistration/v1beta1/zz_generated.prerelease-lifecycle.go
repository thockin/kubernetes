...
func (in *MutatingWebhookConfiguration) APILifecycleReplacement() pkgruntimeschema.GroupVersionKind {
	return pkgruntimeschema.GroupVersionKind{Group: "admissionregistration.k8s.io", Version: "v1", Kind: "MutatingWebhookConfiguration"}
}
...
// APILifecycleReplacement is an autogenerated function, returning the group, version, and kind that should be used instead of this deprecated type.
// It is controlled by "k8s:prerelease-lifecycle-gen:replacement=<group>,<version>,<kind>" tags in types.go.
func (in *MutatingWebhookConfigurationList) APILifecycleReplacement() pkgruntimeschema.GroupVersionKind {
	return pkgruntimeschema.GroupVersionKind{Group: "admissionregistration.k8s.io", Version: "v1", Kind: "MutatingWebhookConfigurationList"}
}
...
// APILifecycleReplacement is an autogenerated function, returning the group, version, and kind that should be used instead of this deprecated type.
// It is controlled by "k8s:prerelease-lifecycle-gen:replacement=<group>,<version>,<kind>" tags in types.go.
func (in *ValidatingWebhookConfiguration) APILifecycleReplacement() pkgruntimeschema.GroupVersionKind {
	return pkgruntimeschema.GroupVersionKind{Group: "admissionregistration.k8s.io", Version: "v1", Kind: "ValidatingWebhookConfiguration"}
}
...
// APILifecycleReplacement is an autogenerated function, returning the group, version, and kind that should be used instead of this deprecated type.
// It is controlled by "k8s:prerelease-lifecycle-gen:replacement=<group>,<version>,<kind>" tags in types.go.
func (in *ValidatingWebhookConfigurationList) APILifecycleReplacement() pkgruntimeschema.GroupVersionKind {
	return pkgruntimeschema.GroupVersionKind{Group: "admissionregistration.k8s.io", Version: "v1", Kind: "ValidatingWebhookConfigurationList"}
}
