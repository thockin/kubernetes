...
type FlowSchemaLister interface {
	...
	List(selector labels.Selector) (ret []*apiflowcontrolv1beta2.FlowSchema, err error)
	// Get retrieves the FlowSchema from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiflowcontrolv1beta2.FlowSchema, error)
...
// List lists all FlowSchemas in the indexer.
func (s *flowSchemaLister) List(selector labels.Selector) (ret []*apiflowcontrolv1beta2.FlowSchema, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*apiflowcontrolv1beta2.FlowSchema))
	})
	return ret, err
}

// Get retrieves the FlowSchema from the index for a given name.
func (s *flowSchemaLister) Get(name string) (*apiflowcontrolv1beta2.FlowSchema, error) {
