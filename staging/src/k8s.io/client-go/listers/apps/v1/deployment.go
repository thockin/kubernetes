...
type DeploymentLister interface {
	...
	List(selector labels.Selector) (ret []*apiappsv1.Deployment, err error)
...
// List lists all Deployments in the indexer.
func (s *deploymentLister) List(selector labels.Selector) (ret []*apiappsv1.Deployment, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*apiappsv1.Deployment))
	})
	return ret, err
}
...
// List lists all Deployments in the indexer for a given namespace.
func (s deploymentNamespaceLister) List(selector labels.Selector) (ret []*apiappsv1.Deployment, err error) {
...
// Get retrieves the Deployment from the indexer for a given namespace and name.
func (s deploymentNamespaceLister) Get(name string) (*apiappsv1.Deployment, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(apiappsv1.Resource("deployment"), name)
	}
	return obj.(*apiappsv1.Deployment), nil
}
