...
type LeaseInformer interface {
	...
	Lister() listerscoordinationv1.LeaseLister
}
...
func (f *leaseInformer) Lister() listerscoordinationv1.LeaseLister {
	return listerscoordinationv1.NewLeaseLister(f.Informer().GetIndexer())
}
