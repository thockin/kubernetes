...
type StatefulSetInformer interface {
	...
	Lister() listersappsv1beta1.StatefulSetLister
}
...
func (f *statefulSetInformer) Lister() listersappsv1beta1.StatefulSetLister {
	return listersappsv1beta1.NewStatefulSetLister(f.Informer().GetIndexer())
}
