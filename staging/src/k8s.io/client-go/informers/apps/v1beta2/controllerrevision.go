...
type ControllerRevisionInformer interface {
	...
	Lister() listersappsv1beta2.ControllerRevisionLister
}
...
func (f *controllerRevisionInformer) Lister() listersappsv1beta2.ControllerRevisionLister {
	return listersappsv1beta2.NewControllerRevisionLister(f.Informer().GetIndexer())
}
