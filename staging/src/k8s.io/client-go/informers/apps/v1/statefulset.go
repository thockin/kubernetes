...
type StatefulSetInformer interface {
	...
	Lister() listersappsv1.StatefulSetLister
}
...
func (f *statefulSetInformer) Lister() listersappsv1.StatefulSetLister {
	return listersappsv1.NewStatefulSetLister(f.Informer().GetIndexer())
}
