...
type Interface interface {
	...
	V1() informersbatchv1.Interface
	// V1beta1 provides access to shared informers for resources in V1beta1.
	V1beta1() informersbatchv1beta1.Interface
}
...
// V1 returns a new informersbatchv1.Interface.
func (g *group) V1() informersbatchv1.Interface {
	return informersbatchv1.New(g.factory, g.namespace, g.tweakListOptions)
}

// V1beta1 returns a new informersbatchv1beta1.Interface.
func (g *group) V1beta1() informersbatchv1beta1.Interface {
	return informersbatchv1beta1.New(g.factory, g.namespace, g.tweakListOptions)
}
