...
type CronJobInformer interface {
	...
	Lister() listersbatchv1.CronJobLister
}
...
func (f *cronJobInformer) Lister() listersbatchv1.CronJobLister {
	return listersbatchv1.NewCronJobLister(f.Informer().GetIndexer())
}
