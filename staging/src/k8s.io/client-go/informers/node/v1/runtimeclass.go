...
type RuntimeClassInformer interface {
	...
	Lister() listersnodev1.RuntimeClassLister
}
...
func (f *runtimeClassInformer) Lister() listersnodev1.RuntimeClassLister {
	return listersnodev1.NewRuntimeClassLister(f.Informer().GetIndexer())
}
