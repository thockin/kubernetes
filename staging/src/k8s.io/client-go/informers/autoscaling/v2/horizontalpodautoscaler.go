...
func (f *horizontalPodAutoscalerInformer) Lister() listersautoscalingv2.HorizontalPodAutoscalerLister {
	return listersautoscalingv2.NewHorizontalPodAutoscalerLister(f.Informer().GetIndexer())
}
