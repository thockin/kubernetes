...
func (f *horizontalPodAutoscalerInformer) Lister() listersautoscalingv1.HorizontalPodAutoscalerLister {
	return listersautoscalingv1.NewHorizontalPodAutoscalerLister(f.Informer().GetIndexer())
}
