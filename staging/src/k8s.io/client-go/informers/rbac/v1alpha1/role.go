...
type RoleInformer interface {
	...
	Lister() listersrbacv1alpha1.RoleLister
}
...
func (f *roleInformer) Lister() listersrbacv1alpha1.RoleLister {
	return listersrbacv1alpha1.NewRoleLister(f.Informer().GetIndexer())
}
