...
import (
	informersapiserverinternalv1alpha1 "k8s.io/client-go/informers/apiserverinternal/v1alpha1"
...
type Interface interface {
	...
	V1alpha1() informersapiserverinternalv1alpha1.Interface
}
...
// V1alpha1 returns a new informersapiserverinternalv1alpha1.Interface.
func (g *group) V1alpha1() informersapiserverinternalv1alpha1.Interface {
	return informersapiserverinternalv1alpha1.New(g.factory, g.namespace, g.tweakListOptions)
}
