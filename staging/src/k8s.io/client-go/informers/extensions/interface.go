...
import (
	informersextensionsv1beta1 "k8s.io/client-go/informers/extensions/v1beta1"
...
type Interface interface {
	...
	V1beta1() informersextensionsv1beta1.Interface
}
...
// V1beta1 returns a new informersextensionsv1beta1.Interface.
func (g *group) V1beta1() informersextensionsv1beta1.Interface {
	return informersextensionsv1beta1.New(g.factory, g.namespace, g.tweakListOptions)
}
