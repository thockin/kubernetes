...
type IngressInformer interface {
	...
	Lister() listersextensionsv1beta1.IngressLister
}
...
func (f *ingressInformer) Lister() listersextensionsv1beta1.IngressLister {
	return listersextensionsv1beta1.NewIngressLister(f.Informer().GetIndexer())
}
