...
type PriorityClassInformer interface {
	...
	Lister() listersschedulingv1alpha1.PriorityClassLister
}
...
func (f *priorityClassInformer) Lister() listersschedulingv1alpha1.PriorityClassLister {
	return listersschedulingv1alpha1.NewPriorityClassLister(f.Informer().GetIndexer())
}
