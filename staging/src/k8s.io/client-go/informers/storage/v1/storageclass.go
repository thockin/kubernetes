...
type StorageClassInformer interface {
	...
	Lister() listersstoragev1.StorageClassLister
}
...
func (f *storageClassInformer) Lister() listersstoragev1.StorageClassLister {
	return listersstoragev1.NewStorageClassLister(f.Informer().GetIndexer())
}
