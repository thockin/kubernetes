...
func (f *cSIStorageCapacityInformer) Lister() listersstoragev1.CSIStorageCapacityLister {
	return listersstoragev1.NewCSIStorageCapacityLister(f.Informer().GetIndexer())
}
