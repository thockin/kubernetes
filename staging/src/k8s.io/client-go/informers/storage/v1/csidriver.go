...
type CSIDriverInformer interface {
	...
	Lister() listersstoragev1.CSIDriverLister
}
...
func (f *cSIDriverInformer) Lister() listersstoragev1.CSIDriverLister {
	return listersstoragev1.NewCSIDriverLister(f.Informer().GetIndexer())
}
