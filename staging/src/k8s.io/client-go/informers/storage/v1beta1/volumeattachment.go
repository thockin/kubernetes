...
func (f *volumeAttachmentInformer) Lister() listersstoragev1beta1.VolumeAttachmentLister {
	return listersstoragev1beta1.NewVolumeAttachmentLister(f.Informer().GetIndexer())
}
