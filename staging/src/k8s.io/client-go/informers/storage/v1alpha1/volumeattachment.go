...
type VolumeAttachmentInformer interface {
	...
	Lister() listersstoragev1alpha1.VolumeAttachmentLister
}
...
func (f *volumeAttachmentInformer) Lister() listersstoragev1alpha1.VolumeAttachmentLister {
	return listersstoragev1alpha1.NewVolumeAttachmentLister(f.Informer().GetIndexer())
}
