...
type ValidatingWebhookConfigurationInformer interface {
	...
	Lister() listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationLister
}
...
func (f *validatingWebhookConfigurationInformer) Lister() listersadmissionregistrationv1beta1.ValidatingWebhookConfigurationLister {
	return listersadmissionregistrationv1beta1.NewValidatingWebhookConfigurationLister(f.Informer().GetIndexer())
}
