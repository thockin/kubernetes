...
func (f *mutatingWebhookConfigurationInformer) Lister() listersadmissionregistrationv1.MutatingWebhookConfigurationLister {
	return listersadmissionregistrationv1.NewMutatingWebhookConfigurationLister(f.Informer().GetIndexer())
}
