...
func (f *ingressClassInformer) Lister() listersnetworkingv1beta1.IngressClassLister {
	return listersnetworkingv1beta1.NewIngressClassLister(f.Informer().GetIndexer())
}
