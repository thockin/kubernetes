...
func NewForConfig(c *clientgorest.Config) (*AdmissionregistrationV1beta1Client, error) {
	config := *c
...
func NewForConfigAndClient(c *clientgorest.Config, h *http.Client) (*AdmissionregistrationV1beta1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *clientgorest.Config) *AdmissionregistrationV1beta1Client {
...
func New(c clientgorest.Interface) *AdmissionregistrationV1beta1Client {
...
func (c *AdmissionregistrationV1beta1Client) RESTClient() clientgorest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
