...
func (g *genValidations) hasValidations(n *typeNode) bool {
	...
	return g.hasValidationsImpl(n, seen) == Yes
}
...
// recursion.
func (g *genValidations) hasValidationsImpl(n *typeNode, seen map[*typeNode]bool) decision {
	if n == nil {
		return No
	}
	...
	for _, c := range allChildren {
		...
		if d := g.hasValidationsImpl(c.node, seen); d == Yes {
			return Yes
		} else if d == Maybe {
			best = Maybe
		}
