...
func RegisterValidations(scheme *runtime.Scheme) error {
	...
	scheme.AddValidationFunc(new(T5), func(obj, oldObj interface{}, subresources ...string) field.ErrorList {
		if len(subresources) == 0 {
			return Validate_T5(obj.(*T5), nil)
		}
		return field.ErrorList{field.InternalError(nil, fmt.Errorf("No validation found for %T, subresources: %v", obj, subresources))}
	})
	return nil
...
func Validate_T1(obj *T1, fldPath *field.Path) (errs field.ErrorList) {
	...
	// field T1.T3
	errs = append(errs,
		func(obj T3, fldPath *field.Path) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(fldPath, obj, true, "field T1.T3")...)
			return
		}(obj.T3, fldPath.Child("t3"))...)
...
func Validate_T5(obj *T5, fldPath *field.Path) (errs field.ErrorList) {
