...
type AtomicSliceStruct struct {
	...
	// Case: Alpha eachVal, Standard validation
	// +k8s:listType=atomic
	// +k8s:alpha=+k8s:eachVal=+k8s:minimum=10
	AlphaEachValStandardValidation []int `json:"AlphaEachValStandardValidation"`

	// Case: Beta eachVal, Standard validation
	// +k8s:listType=atomic
	// +k8s:beta=+k8s:eachVal=+k8s:minimum=10
	BetaEachValStandardValidation []int `json:"BetaEachValStandardValidation"`
}
