...
func Validate_AtomicSliceStruct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *AtomicSliceStruct) (errs field.ErrorList) {
	...
	// field AtomicSliceStruct.AlphaEachValStandardValidation
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []int, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
			...
			return
		}(fldPath.Child("AlphaEachValStandardValidation"), obj.AlphaEachValStandardValidation, safe.Field(oldObj, func(oldObj *AtomicSliceStruct) []int { return oldObj.AlphaEachValStandardValidation }), oldObj != nil)...)

	// field AtomicSliceStruct.BetaEachValStandardValidation
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []int, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
			...
			return
		}(fldPath.Child("BetaEachValStandardValidation"), obj.BetaEachValStandardValidation, safe.Field(oldObj, func(oldObj *AtomicSliceStruct) []int { return oldObj.BetaEachValStandardValidation }), oldObj != nil)...)
