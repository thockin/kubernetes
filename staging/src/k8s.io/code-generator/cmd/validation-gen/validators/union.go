...
type union struct {
	...
	// itemMembers stores selection criteria for list-item unions.
	// The map key is the "field name" (eg: `field[{"name": "succeeded"}]`),
	// and the value is a list of selection criteria.
