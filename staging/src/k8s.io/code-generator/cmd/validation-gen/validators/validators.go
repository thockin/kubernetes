...
// Validation stability level denote the stage of a validation in the migration process.
type ValidationStabilityLevel string

const (
	// Alpha stage denotes the declarative validations should be run with the handwritten validation. But the handwritten validations are the authoritative.
	ValidationStabilityLevelAlpha ValidationStabilityLevel = "Alpha"
	// Beta stage denotes the declarative validations should be run with the handwritten validation. Declarative validations are authoritative.
