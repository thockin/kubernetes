...
// BasicPackage contains a simple implementation of Package.  It can be used
// on its own or serve as a base for more specialized Package implementations,
// by embedding and overriding methods.
...
func (d *BasicPackage) Generators(c *Context) []Generator {
...
func (d *BasicPackage) Header(filename string) []byte {
	if filename == "doc.go" {
