...
func validateProbe(probe *core.Probe, fldPath *field.Path) field.ErrorList {
	...
	allErrs = append(allErrs, validate.GEZ(probe.InitialDelaySeconds, fldPath.Child("initialDelaySeconds"))...)
	allErrs = append(allErrs, validate.GEZ(probe.TimeoutSeconds, fldPath.Child("timeoutSeconds"))...)
...
func ValidateReplicationControllerStatus(status core.ReplicationControllerStatus, statusPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
	allErrs = append(allErrs, validate.GEZ(status.Replicas, statusPath.Child("replicas"))...)
	allErrs = append(allErrs, validate.GEZ(status.FullyLabeledReplicas, statusPath.Child("fullyLabeledReplicas"))...)
	allErrs = append(allErrs, validate.GEZ(status.ReadyReplicas, statusPath.Child("readyReplicas"))...)
	allErrs = append(allErrs, validate.GEZ(status.AvailableReplicas, statusPath.Child("availableReplicas"))...)
	allErrs = append(allErrs, validate.GEZ(status.ObservedGeneration, statusPath.Child("observedGeneration"))...)
