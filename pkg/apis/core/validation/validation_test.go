...
func TestValidateServiceCreate(t *testing.T) {
	...
	testCases := []struct {
		...
		/* ip families validation */
		{
			...
			tweakSvc: func(s *core.Service) {
				invalidServiceIPFamily := common.IPFamily("not-a-valid-ip-family")
				s.Spec.IPFamilies = []common.IPFamily{invalidServiceIPFamily}
			},
			numErrs: 1,
		},
		{
			...
			tweakSvc: func(s *core.Service) {
				...
				s.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv4, invalidServiceIPFamily}
			},
			numErrs: 1,
		},
		{
			...
			tweakSvc: func(s *core.Service) {
				...
				s.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv4, common.IPFamilyIPv6}
			},
...

		{
			...
			tweakSvc: func(s *core.Service) {
				s.Spec.IPFamilyPolicy = &requireDualStack
				s.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv4, common.IPFamilyIPv6, common.IPFamilyIPv4}
			},
			numErrs: 1,
		},
		{
			...
			tweakSvc: func(s *core.Service) {
				s.Spec.IPFamilyPolicy = &requireDualStack
				s.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv6, common.IPFamilyIPv6}
			},
			numErrs: 1,
		},
		{
		...
		},
		{
			...
			tweakSvc: func(s *core.Service) {
				s.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv4}
			},
			numErrs: 0,
		},
		{
			...
			tweakSvc: func(s *core.Service) {
				s.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv6}
			},
			numErrs: 0,
		},
		{
		...
		},
		{
			...
			tweakSvc: func(s *core.Service) {
				s.Spec.IPFamilyPolicy = &requireDualStack
				s.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv6, common.IPFamilyIPv4}
			},
			numErrs: 0,
		},
		{
	...
	testCases := []struct {
		...
		},
		{
			...
			tweakSvc: func(oldSvc, newSvc *core.Service) {
				...
				oldSvc.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv4}
				...
				*/
				...
				newSvc.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv4}
...

		{
			...
			tweakSvc: func(oldSvc, newSvc *core.Service) {
				...
				newSvc.Spec.IPFamilyPolicy = &requireDualStack
				newSvc.Spec.Type = core.ServiceTypeClusterIP
				newSvc.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv4, common.IPFamilyIPv6}
			},
			numErrs: 0,
		},
		...
		},
		{
			...
			tweakSvc: func(oldSvc, newSvc *core.Service) {
				...
				newSvc.Spec.ExternalName = "somename"
				newSvc.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv6}
			},
			numErrs: 0,
		},
		{
		...
		},
		{
			...
			tweakSvc: func(oldSvc, newSvc *core.Service) {
				...
				oldSvc.Spec.Type = core.ServiceTypeClusterIP
				oldSvc.Spec.IPFamilyPolicy = &requireDualStack
				oldSvc.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv4, common.IPFamilyIPv6}
		...
		},
		{
			...
			tweakSvc: func(oldSvc, newSvc *core.Service) {
				...
				newSvc.Spec.ClusterIPs = []string{"None"}
				newSvc.Spec.IPFamilyPolicy = &requireDualStack
				newSvc.Spec.IPFamilies = []common.IPFamily{common.IPFamilyIPv6, common.IPFamilyIPv4}
			},
			numErrs: 0,
		},
		{
