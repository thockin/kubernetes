...
func TestValidateServerStorageVersion(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			expectedErr: `[].decodableVersions[1]: Invalid value: "/v3": group must be specified`,
		},
		{
			ssv: apiserverinternal.ServerStorageVersion{
				APIServerID:       "fea",
			...
			expectedErr: `[].decodableVersions[1]: Invalid value: "mygroup.com/": version must be specified`,
		},
		{
			ssv: apiserverinternal.ServerStorageVersion{
				APIServerID:       "fea",
			...
			expectedErr: `[].encodingVersion: Invalid value: "/v3": group must be specified`,
		},
		{
			ssv: apiserverinternal.ServerStorageVersion{
				APIServerID:       "fea",
		...
		},
		{
			...
			expectedErr: `[].decodableVersions[1]: Invalid value: "mygroup.com/v2_": version part: a DNS-1035 label must consist of lower case alphanumeric characters or '-', start with an alphabetic character, and end with an alphanumeric character (e.g. 'my-name', 'abc-123'; regex: '[a-z]([-a-z0-9]*[a-z0-9])?')`,
		},
		{
			ssv: apiserverinternal.ServerStorageVersion{
				APIServerID:       "fea",
