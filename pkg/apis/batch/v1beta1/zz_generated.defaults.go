...
func RegisterDefaults(scheme *apimachinerypkgruntime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&apibatchv1beta1.CronJob{}, func(obj interface{}) { SetObjectDefaults_CronJob(obj.(*apibatchv1beta1.CronJob)) })
	scheme.AddTypeDefaultingFunc(&apibatchv1beta1.CronJobList{}, func(obj interface{}) { SetObjectDefaults_CronJobList(obj.(*apibatchv1beta1.CronJobList)) })
	scheme.AddTypeDefaultingFunc(&apibatchv1beta1.JobTemplate{}, func(obj interface{}) { SetObjectDefaults_JobTemplate(obj.(*apibatchv1beta1.JobTemplate)) })
	return nil
}

func SetObjectDefaults_CronJob(in *apibatchv1beta1.CronJob) {
...
func SetObjectDefaults_CronJobList(in *apibatchv1beta1.CronJobList) {
...
func SetObjectDefaults_JobTemplate(in *apibatchv1beta1.JobTemplate) {
	apiscorev1.SetDefaults_PodSpec(&in.Template.Spec.Template.Spec)
	...
	apiscorev1.SetDefaults_ResourceList(&in.Template.Spec.Template.Spec.Overhead)
}
