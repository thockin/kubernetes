...
func RegisterConversions(s *apimachinerypkgruntime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*apibatchv1beta1.JobTemplate)(nil), (*pkgapisbatch.JobTemplate)(nil), func(a, b interface{}, scope apimachinerypkgconversion.Scope) error {
		return Convert_v1beta1_JobTemplate_To_batch_JobTemplate(a.(*apibatchv1beta1.JobTemplate), b.(*pkgapisbatch.JobTemplate), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*pkgapisbatch.JobTemplate)(nil), (*apibatchv1beta1.JobTemplate)(nil), func(a, b interface{}, scope apimachinerypkgconversion.Scope) error {
		return Convert_batch_JobTemplate_To_v1beta1_JobTemplate(a.(*pkgapisbatch.JobTemplate), b.(*apibatchv1beta1.JobTemplate), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_JobTemplate_To_batch_JobTemplate(in *apibatchv1beta1.JobTemplate, out *pkgapisbatch.JobTemplate, s apimachinerypkgconversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
...
func Convert_v1beta1_JobTemplate_To_batch_JobTemplate(in *apibatchv1beta1.JobTemplate, out *pkgapisbatch.JobTemplate, s apimachinerypkgconversion.Scope) error {
	return autoConvert_v1beta1_JobTemplate_To_batch_JobTemplate(in, out, s)
}

func autoConvert_batch_JobTemplate_To_v1beta1_JobTemplate(in *pkgapisbatch.JobTemplate, out *apibatchv1beta1.JobTemplate, s apimachinerypkgconversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
...
func Convert_batch_JobTemplate_To_v1beta1_JobTemplate(in *pkgapisbatch.JobTemplate, out *apibatchv1beta1.JobTemplate, s apimachinerypkgconversion.Scope) error {
