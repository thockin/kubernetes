...
func TestValidateCertificateSigningRequestCreate(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"signerName path component is empty": {
			...
			errs: field.ErrorList{
				field.Invalid(specPath.Child("signerName"), "", `validating label "": must consist of lower case alphanumeric characters, '-', or '.', and must start and end with an alphanumeric character (e.g. 'example.com'; regex: '[a-z0-9]([-a-z0-9]*[a-z0-9])?(\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*')`),
			},
		},
		"signerName path component ends with a symbol": {
			...
			errs: field.ErrorList{
				field.Invalid(specPath.Child("signerName"), "something-", `validating label "something-": must consist of lower case alphanumeric characters, '-', or '.', and must start and end with an alphanumeric character (e.g. 'example.com'; regex: '[a-z0-9]([-a-z0-9]*[a-z0-9])?(\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*')`),
			},
		},
