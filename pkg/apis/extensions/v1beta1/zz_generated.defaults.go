...
func RegisterDefaults(scheme *apimachinerypkgruntime.Scheme) error {
	...
	scheme.AddTypeDefaultingFunc(&apiextensionsv1beta1.PodSecurityPolicy{}, func(obj interface{}) {
		SetObjectDefaults_PodSecurityPolicy(obj.(*apiextensionsv1beta1.PodSecurityPolicy))
	})
	scheme.AddTypeDefaultingFunc(&apiextensionsv1beta1.PodSecurityPolicyList{}, func(obj interface{}) {
		SetObjectDefaults_PodSecurityPolicyList(obj.(*apiextensionsv1beta1.PodSecurityPolicyList))
	})
...
func SetObjectDefaults_PodSecurityPolicy(in *apiextensionsv1beta1.PodSecurityPolicy) {
	SetDefaults_PodSecurityPolicySpec(&in.Spec)
}

func SetObjectDefaults_PodSecurityPolicyList(in *apiextensionsv1beta1.PodSecurityPolicyList) {
	for i := range in.Items {
		a := &in.Items[i]
