...
func RegisterConversions(s *apimachinerypkgruntime.Scheme) error {
	...
	if err := s.AddConversionFunc((*controllerserviceaccountconfig.SAControllerConfiguration)(nil), (*kubecontrollermanagerconfigv1alpha1.SAControllerConfiguration)(nil), func(a, b interface{}, scope apimachinerypkgconversion.Scope) error {
		return Convert_config_SAControllerConfiguration_To_v1alpha1_SAControllerConfiguration(a.(*controllerserviceaccountconfig.SAControllerConfiguration), b.(*kubecontrollermanagerconfigv1alpha1.SAControllerConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*kubecontrollermanagerconfigv1alpha1.SAControllerConfiguration)(nil), (*controllerserviceaccountconfig.SAControllerConfiguration)(nil), func(a, b interface{}, scope apimachinerypkgconversion.Scope) error {
		return Convert_v1alpha1_SAControllerConfiguration_To_config_SAControllerConfiguration(a.(*kubecontrollermanagerconfigv1alpha1.SAControllerConfiguration), b.(*controllerserviceaccountconfig.SAControllerConfiguration), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_SAControllerConfiguration_To_config_SAControllerConfiguration(in *kubecontrollermanagerconfigv1alpha1.SAControllerConfiguration, out *controllerserviceaccountconfig.SAControllerConfiguration, s apimachinerypkgconversion.Scope) error {
