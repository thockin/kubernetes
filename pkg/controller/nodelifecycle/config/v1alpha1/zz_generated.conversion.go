...
import (
	...
	controllernodelifecycleconfig "k8s.io/kubernetes/pkg/controller/nodelifecycle/config"
)
...
func RegisterConversions(s *apimachinerypkgruntime.Scheme) error {
	...
	if err := s.AddConversionFunc((*controllernodelifecycleconfig.NodeLifecycleControllerConfiguration)(nil), (*kubecontrollermanagerconfigv1alpha1.NodeLifecycleControllerConfiguration)(nil), func(a, b interface{}, scope apimachinerypkgconversion.Scope) error {
		return Convert_config_NodeLifecycleControllerConfiguration_To_v1alpha1_NodeLifecycleControllerConfiguration(a.(*controllernodelifecycleconfig.NodeLifecycleControllerConfiguration), b.(*kubecontrollermanagerconfigv1alpha1.NodeLifecycleControllerConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*kubecontrollermanagerconfigv1alpha1.NodeLifecycleControllerConfiguration)(nil), (*controllernodelifecycleconfig.NodeLifecycleControllerConfiguration)(nil), func(a, b interface{}, scope apimachinerypkgconversion.Scope) error {
		return Convert_v1alpha1_NodeLifecycleControllerConfiguration_To_config_NodeLifecycleControllerConfiguration(a.(*kubecontrollermanagerconfigv1alpha1.NodeLifecycleControllerConfiguration), b.(*controllernodelifecycleconfig.NodeLifecycleControllerConfiguration), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_NodeLifecycleControllerConfiguration_To_config_NodeLifecycleControllerConfiguration(in *kubecontrollermanagerconfigv1alpha1.NodeLifecycleControllerConfiguration, out *controllernodelifecycleconfig.NodeLifecycleControllerConfiguration, s apimachinerypkgconversion.Scope) error {
	if err := apismetav1.Convert_Pointer_bool_To_bool(&in.EnableTaintManager, &out.EnableTaintManager, s); err != nil {
		return err
	}
...
func autoConvert_config_NodeLifecycleControllerConfiguration_To_v1alpha1_NodeLifecycleControllerConfiguration(in *controllernodelifecycleconfig.NodeLifecycleControllerConfiguration, out *kubecontrollermanagerconfigv1alpha1.NodeLifecycleControllerConfiguration, s apimachinerypkgconversion.Scope) error {
	if err := apismetav1.Convert_bool_To_Pointer_bool(&in.EnableTaintManager, &out.EnableTaintManager, s); err != nil {
		return err
	}
	out.NodeEvictionRate = in.NodeEvictionRate
	out.SecondaryNodeEvictionRate = in.SecondaryNodeEvictionRate
