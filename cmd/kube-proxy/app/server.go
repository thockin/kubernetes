...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.Var(cliflag.NewMapStringBool(&o.config.FeatureGates), "feature-gates", "1111 A set of key=value pairs that describe feature gates for alpha/experimental features. "+
