...
// ExtractFunctionalCommentTags parses comments for special metadata tags. The
...
//				Value: "\"qux\""
//		}}
func ExtractFunctionalCommentTags(marker string, prefixes []string, lines []string) (map[string][]Tag, error) {
	stripComment := func(in string) string {
